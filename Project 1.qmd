...
process_data_step_1_2 <- function(data, value_column = "enrollment_value") {
...
# Call my_wrapper function for both URLs
result1 <- my_wrapper(url1, default_var_name = "enrollment_value")
result2 <- my_wrapper(url2, default_var_name = "enrollment_value")
...
result3 <- my_wrapper(url3, default_var_name = "enrollment_value")
result4 <- my_wrapper(url4, default_var_name = "enrollment_value")
result5 <- my_wrapper(url5, default_var_name = "enrollment_value")
result6 <- my_wrapper(url6, default_var_name = "enrollment_value")
